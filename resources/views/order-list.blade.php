                    ...
                    <table class="footable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Bank Wire</td>
                                <td><a href="{{ route('order-status') }}" class="btn btn-primary btn-sm">view status</a></td>
                                <td>$403</td>
                            ...
                            <tr>
                                ...
                                <td data-value="1"><a target="_blank"><span
                                            class="label label-primary">Pending</span></a>
                                </td>
                            </tr>
                            <tr>
                                <td>#518JOK</td>

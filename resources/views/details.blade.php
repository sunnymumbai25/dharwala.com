            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                ...
                <div class="main-image sp-wrap col-lg-12 no-padding">
                    <a href="images/product_details/hi-res-croped/1.jpg"><img
                            src="{{ asset('images/product_details/low-res-white/1.jpg') }}" class="img-responsive" alt="img"></a>
                    <a href="images/product_details/hi-res-croped/2.jpg"><img
                            src="{{ asset('images/product_details/low-res-white/2.jpg') }}" class="img-responsive" alt="img"></a>
                    <a href="images/product_details/hi-res-croped/3.jpg"><img
                            src="{{ asset('images/product_details/low-res-white/3.jpg') }}" class="img-responsive" alt="img"></a>
                </div>
            </div>
                ...
                <h1 class="product-title"> Lorem ipsum dolor sit amet</h2>
                    ...
                    <div class="cart-actions">
                        <div class="addto row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"><a
                                    class="link-wishlist wishlist btn-block ">Add
                                    to Wishlist</a></div>
                        </div>
                        <div style="clear:both"></div>
                        <h3 class="incaps"><i class="fa fa fa-check-circle-o color-in"></i> In stock</h3>
                        <h3 style="display:none" class="incaps"><i class="fa fa-minus-circle color-out"></i> Out of
                            stock
                        </h3>
                    ...
                    <div class="product-tab w100 clearfix">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="details">Sed ut eros felis. Vestibulum rutrum imperdiet
                                nunc a

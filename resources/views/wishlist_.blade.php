                        ...
                        <tbody>
                            <tr class="CartProduct">
                                <td style="width:10%" class="CartProductThumb">
                                    <div><a href="{{ route('product-details') }}"><img src="images/product/9.jpg" alt="img"></a>
                                    </div>
                                </td>
                                <td style="width:40%">
                                ...
                                <td style="width:15%">
                                    <a class="btn btn-primary">
                                        <span class="add2cart"><i class="glyphicon glyphicon-shopping-cart"> </i> Add to
                                            cart </span>
                                    </a>
                                </td>
                            ...
                            <tr class="CartProduct">
                                <td style="width:10%" class="CartProductThumb">
                                    <div><a href="{{ route('product-details') }}">

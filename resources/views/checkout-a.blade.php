                ...
                <div class="col-xs-12 col-sm-12">
                    <div class="w100 clearfix">
                        <ul class="orderStep orderStepLook2">
                            <li class="active"><a href="{{ route('checkout-1') }}"> <i class="fa fa-map-marker "></i> <span>
                                        address</span>
                                </a></li>
                            ...
                            <li><a href="{{ route('checkout-4') }}"><i class="fa fa-money  "> </i><span>Payment</span> </a></li>
                                ...
                                <div class="col-xs-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="InputAdditionalInformation" class="form-control"
                                            name="InputAdditionalInformation" cols="26" rows="3"></textarea>
                                    </div>
                                    <div class="form-group required">
                    ...
                    <div class="cartFooter w100">
                        <div class="box-footer">
                            <div class="pull-left"><a href="{{ route('home') }}" class="btn btn-default"> <i
                                        class="fa fa-arrow-left"></i> &nbsp; Back to Shop </a></div>
                            <div class="pull-right"><a href="{{ route('checkout-2') }}.html" class="btn btn-primary btn-small ">

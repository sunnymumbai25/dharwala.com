  ...
  <div class="navbar navbar-tshop navbar-fixed-top megamenu" role="navigation">
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand " href="{{ route('home') }}"> <img src="{{ asset('images/logo.png') }}" alt="TSHOP"> </a>
      ...
      <div class="navbar-cart  collapse">
        <div class="cartMenu  col-lg-4 col-xs-12 col-md-4 ">
          ...
          <div class="miniCartFooter  miniCartFooterInMobile text-right">
            ...
            <a class="btn btn-sm btn-danger" href="{{ route('cart') }}"> <i class="fa fa-shopping-cart"> </i> VIEW CART </a> <a
              href="checkout-0.html" class="btn btn-sm btn-primary"> CHECKOUT </a>
          </div>
        </div>
      </div>
            ...
            <ul class="dropdown-menu">
              <li class="megamenu-content ProductDetailsList">
                ...
                <ul class="col-lg-2  col-sm-2 col-md-2 unstyled">
                  ...
                  <li><a href="sidebar-shopping-{{ route('cart') }}">Sidebar Shopping cart <span
                        class="label label-success">new</span></a></li>
                </ul>
                <ul class="col-lg-2  col-sm-2 col-md-2 unstyled">
                  <li class="no-border">
